...
public class ThreeProduct {
        ...
        public void trianglesTransparentSphere() {
            scene.geometries.add(
                    ...
                    new Sphere(new Point(-48.33,-1.67,-105), 10d).setEmission(new Color(BLACK))
                            .setMaterial(new Material().setKd(0.2).setKs(0.2).setShininess(30).setKt(0.1)),
                    new Sphere(new Point(40,-1.67,-105), 20d).setEmission(new Color(RED))
                            .setMaterial(new Material().setKd(0.5).setKs(0.2).setShininess(40)));
            scene.setAmbientLight(new AmbientLight(new Color(WHITE), 0.1));
            scene.lights.add(
             //       new DirectionalLight(new Color(YELLOW),new Vector(-20,20,10)));
                    new PointLight(new Color(WHITE), new Point(30, 50, -20)));

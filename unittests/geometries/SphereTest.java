...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        final var result5 = sphere.findIntersections(new Ray(new Point(1,1,0), new Vector(0,-1,0))).stream().toList();
        ...
        assertEquals(List.of(new Point(1,1,0)), result6, "Ray crosses sphere");

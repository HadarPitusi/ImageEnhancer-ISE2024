...
class GeometriesTest {
    ...
    void testFindIntersections() {
        ...
        Point p7= new Point(1,1,1);/////?לתקן
        Vector v1=new Vector(0,0,1);
        Ray ray= new Ray(new Point(5,6,-7), v1);
        ...
        // TC10: אוסף גופים ריק
        assertNull(emptyGeo.findIntersections(ray),"Error: the collection is empty");
        ...
        assertEquals(1, geo.findIntersections(ray).size(), "ERROR: wrong result");

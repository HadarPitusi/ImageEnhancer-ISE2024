...
public class LightsTests {
     ...
     */
    private final Color trianglesLightColor = new Color(YELLOW);
    private final Color trianglesLightColor2 = new Color(BLUE);
    private final Color trianglesLightColor3 = new Color(RED);
    /**
    ...
    ////////
    private final Color sphereLightColor2 = new Color(20, 500, 0);
    private final Color sphereLightColor3 = new Color(WHITE);
    /**
    ...
    //////////
    private final Vector sphereLightDirection2 = new Vector(30, -25, -1);
    ...
    //////////
    private final Point trianglesLightPosition2 = new Point(0, 0, -50);
    private final Point trianglesLightPosition3 = new Point(40, 10, -110);
    /**
     * Light direction (directional and spot) in tests with triangles
     */
    private final Vector trianglesLightDirection = new Vector(-2, -2, -2);
    private final Vector trianglesLightDirection2 = new Vector(0, 0, -50);
    ...
    ///////////
    @Test
    public void sphereLight() {
        scene1.geometries.add(sphere);
        scene1.lights.add(new SpotLight(sphereLightColor, sphereLightPosition, sphereLightDirection)
                .setKl(0.001).setKq(0.0001));
        scene1.lights.add(new PointLight(sphereLightColor2, sphereLightPosition2));//.setKc(0.1));
        //  .setKl(1).setKq(0.1));
    ...
    @Test
    public void trianglesLight() {
        scene2.geometries.add(triangle1, triangle2);
        scene2.lights.add(new PointLight(trianglesLightColor2, trianglesLightPosition2)
                .setKl(0.001).setKq(0.0002));
        scene2.lights.add(new DirectionalLight(trianglesLightColor, trianglesLightDirection));
        scene2.lights.add(new SpotLight(trianglesLightColor3, trianglesLightPosition3, trianglesLightDirection)
                .setKl(0.001).setKq(0.0001));

        camera2.setImageWriter(new ImageWriter("myTriangle", 500, 500)) //
                .build() //
                .renderImage() //
                .writeToImage(); //
    }
